            ...
            >
              ...
              >
                <div className="text-2xl mb-4 font-semibold text-white text-center tracking-wider">
                  Open Native Env in a new tab?
                </div>
                <div className="text-neutral-400 text-sm mb-8 text-center max-w-[260px]">
                  You are about to leave this workspace and open <span className="text-[#1ed760] font-medium">native env</span> in a new browser tab.
                </div>
                <div className="flex gap-9">
                  {/* Confirm Button */}
                  <button
                    onClick={handleOpenNativeEnv}
